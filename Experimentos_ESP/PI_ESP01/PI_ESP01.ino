/*--------------------------------------------------------------------------
  ...
  Transmissão via bluetooh e wifi para uma planilha google.
...
//Strings unicas para um formulario google
String textFix = "/forms/d/e/1FAIpQLSdwNWQtjetH4hj_MkRDOeBXkV6ib8LLgmO8th9dk3t6ePcz_g/formResponse?ifq";
String inputName = "&entry.911139776=Plano_Inclinado";
String input1 = "&entry.1827900739=";
String input2 = "&entry.1917433581=";
String input3 = "&entry.246745679=";
String input4 = "&entry.716066615=";
String input5 = "&entry.1880225264=";
...
void loop() {
  ...
  input3 += T3;
  input4 += T4;
  String URL = "GET" + inputName + input1 + input2 + input3 + input4;
  Serial.println("[URL]");
  Serial.println(URL);
  Serial.println("[SEND_WIFI]")
